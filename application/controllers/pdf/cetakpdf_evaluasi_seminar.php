...
class cetakpdf_evaluasi_seminar extends CI_Controller {
	...
	function index()
	{
        $data = $this->ion_auth_model->tampil_data_verifikasiSeminar();
        $data1 = $this->ion_auth_model->tampil_nilai_seminar();
        ...
        $pdf->Cell(25,14,'',0,0);
        $pdf->Cell(15,7,$row->hari_seminar,1,0);
        $pdf->Cell(30,7,$row->tgl_seminar,1,0,'');
        $pdf->Cell(23,7,$row->jam_seminar,1,0,'C');
        $pdf->Cell(14,7,$row->tempat_seminar,1,0,'C');
        $pdf->Cell(68,7,'',1,1,'C');
        $pdf->Cell(25,14,'DOSEN REV',1,0,'C',true);
        $pdf->Cell(5,7,'1.',1,0);
        $pdf->Cell(77,7,$row->kd_penguji1,1,0);
        ...
        $pdf->Cell(25,14,'',0,0);
        $pdf->Cell(5,7,'2.',1,0);
        $pdf->Cell(77,7,$row->kd_penguji2,1,0);
        $pdf->Cell(10,7,'NID.',1,0,'C',true);
        $pdf->Cell(34,7,'',1,0);
        $pdf->Cell(10,7,'ID.',1,0,'C',true);
        $pdf->Cell(14,7,'',1,1);
        ...
        $pdf->Cell(35,7,$row->nim,1,0);
        $pdf->Cell(75,7,$row->nama_lengkap,1,1);
        $pdf->Cell(25,7,'',0,0);
        $pdf->Cell(40,7,'SMT/TA/PEMINATAN',1,0);
        $pdf->Cell(10,7,$row->semester,1,0);
        $pdf->Cell(40,7,'',1,0);
        $pdf->Cell(60,7,$row->peminatan,1,1);
        $pdf->Cell(25,14,'',0,0);
        $pdf->Cell(40,14,'DOSEN PEM',1,0);
        $pdf->Cell(64,7,$row->pembimbing_1,1,0);
        $pdf->Cell(10,7,'NID.',1,0,'C',true);
        $pdf->Cell(28,7,'',1,0);
        $pdf->Cell(8,7,'',1,1);
        $pdf->Cell(65,7,'',0,0);
        $pdf->Cell(64,7,$row->pembimbing_2,1,0);
        $pdf->Cell(10,7,'NID.',1,0,'C',true);
        $pdf->Cell(28,7,'',1,0);
        $pdf->Cell(8,7,'',1,1);
        $pdf->Cell(25,14,'',0,0);
        $pdf->Cell(40,22,'JUDUL PENELITIAN',1,0);
        $pdf->Cell(110,22,$row->judul_skripsi,1,1,'C');
        }
        ...
        $pdf->Cell(2,2,'',0,0,'C');
        $pdf->Cell(110,12,$row1->komentar_pemahaman_teori,1,1,'C');
        $pdf->Cell(63,7,$row1->pemahaman_teori,1,1,'C');
        $pdf->Cell(2,2,'',0,1,'C');
        $pdf->Cell(63,12,'PEMAHAMAN KEBUTUHAN',1,0,'C',true);
        $pdf->Cell(2,2,'',0,0,'C');
        $pdf->Cell(110,12,$row1->komentar_pemahaman_kebutuhan,1,1,'C');
        $pdf->Cell(63,7,$row1->pemahaman_kebutuhan,1,1,'C');
        $pdf->Cell(2,2,'',0,1,'C');
        $pdf->Cell(63,12,'PEMAHAMAN PEMBUATAN',1,0,'C',true);
        $pdf->Cell(2,2,'',0,0,'C');
        $pdf->Cell(110,12,$row1->komentar_pemahaman_pl,1,1,'C');
        $pdf->Cell(63,7,$row1->pemahaman_pl,1,1,'C');
        $pdf->Cell(2,2,'',0,1,'C');
        $pdf->Cell(5,3,'',0,1);

        $pdf->Cell(87.5,7,'HASIL REVIEW / REKOMENDASI SIDANG',1,0,'C',TRUE);
        $pdf->Cell(87.5,7,$row1->maju_sidang,1,1,'C');
        $pdf->Cell(2,2,'',0,1,'C');
