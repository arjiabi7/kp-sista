...
class cetakpdf_penilaian_bimbingan extends CI_Controller {
    ...
    function index(){
        ...
        $pdf->Cell(127,10,'FORM PENILAIAN DOSEN PEMBIMBING 1',0,0,'C');
        $pdf->Cell(50,8,'',1,1,'C');
        $pdf->Cell(3,3,'',0,1);
        ...
        $pdf->SetFillColor(247, 185, 141);
        $pdf->Cell(140.5,8,'FORM PENILAIAN BIMBINGAN DAN SIDANG SKRIPSI',1,0,'C',true);
        $pdf->SetFillColor(25, 28, 27);
        $pdf->SetTextColor(252,252,252);
        $pdf->Cell(12,8,'P-1',1,1,'C',true);
        $pdf->Cell(3,3,'',0,1);
        $pdf->SetFillColor(247, 185, 141);
        $pdf->SetTextColor(0,0,0);
        ...
        $pdf->Cell(25,42,'BIMBINGAN',1,0,'C');
        ...
        $pdf->Cell(25,7,'',0,0,'C');
        $pdf->Cell(8,7,'',1,0,'C');
        $pdf->Cell(97,7,'*TEORI PENUNJANG  *PENELITIAN YANG DIKERJAKAN',1,1,'C');
        $pdf->Cell(25,7,'',0,0,'C');
