		...
		<table class="table table-striped table-hover">
			 ...
			 <table  class="table table-striped table-hover">
				<tr>
					...
					<td><?=$this->ion_auth->gabung_tabel_userVerifikasiSeminar()->row()->hari_seminar;?></td></td>

				</tr>
				<tr>
					<td style="width: 200px">TANGGAL</td>
					<td style="width: 10px">:</td>
					<td><?=$this->ion_auth->gabung_tabel_userVerifikasiSeminar()->row()->tgl_seminar;?></td></td>

				</tr>
				<tr>
					<td style="width: 200px">JAM</td>
					<td style="width: 10px">:</td>
					<td><?=$this->ion_auth->gabung_tabel_userVerifikasiSeminar()->row()->jam_seminar;?></td>

				</tr>
				<tr>
					<td style="width: 200px">TEMPAT</td>
					<td style="width: 10px">:</td>
					<td><?=$this->ion_auth->gabung_tabel_userVerifikasiSeminar()->row()->tempat_seminar;?></td>
 ...
 <hr class="my-4">
			 ...
			 <table  class="table table-striped table-hover">
				<tr>
					...
					<td style="width: 10px">:</td>
					<td><?=$this->ion_auth->gabung_tabel_userVerifikasiSeminar()->row()->kd_penguji1;?></td>

				</tr>
				<tr>
					<td style="width: 200px">REVIEWER 2</td>
					<td style="width: 10px">:</td>
					<td><?=$this->ion_auth->gabung_tabel_userVerifikasiSeminar()->row()->kd_penguji2;?></td>
