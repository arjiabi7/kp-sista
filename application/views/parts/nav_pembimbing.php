...
<nav class="navbar navbar-expand-lg bg-dark fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="dropdown">
      <button type="button" class="btn btn-dark dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="ni ni-circle-08"></i><span class="nav-link-text"><?=$this->ion_auth->gabung_tabel_userPembimbing()->row()->nama_pembimbing;?> </span></button>        
