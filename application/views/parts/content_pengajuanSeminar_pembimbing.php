    ...
    <table id="example" class="table table-striped table-bordered text-center" style="width:100%">
     ...
     <?php
        foreach($data->result_array() as $row):
            ...
            $status=$row['status'];
            $komentar_pengajuan_seminar=$row['komentar_pengajuan_seminar'];
        ...
        ?>
                    <div class="modal fade" id="modal_edit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                         <form class="form-horizontal" method="post" action="<?php echo base_url().'index.php/pembimbing/pembimbing/edit_pengajuan_seminar'?>">           
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <textarea class="form-control" name="komentar_pengajuan_seminar" id="komentar_pengajuan_seminar" id="exampleFormControlTextarea1" value="<?php echo $komentar_pengajuan_seminar;?>" rows="3" placeholder="Tuliskan komentar..."></textarea>
                                </div>
