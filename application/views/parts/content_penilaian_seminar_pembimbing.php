...
<html lang="en">
  ...
  <body class="mt-3">
    <?php 
        ...
        ?>
         <?php echo form_open("pembimbing/pembimbing/penilaian_seminar", array('enctype'=>'multipart/form-data')); ?>
    <div class="container p-5 mt-5 mb-5">
        ...
        <form class="p-5">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <input type="text" name="kd_penguji" class="form-control border-top-0 border-right-0 border-left-0" value="<?=$this->ion_auth->userPenilaian_pembimbing()->row()->kd_pembimbing;?>" readonly>
                </div>
                <div class="col-lg-6">
