							...
							<tr>
								...
								<th>
									<?php
								 	...
								 	if($this->ion_auth->gabung_tabel_userVerifikasiSeminar()->row()->komentar_seminar == NULL){
										echo "-";
									}else{
										echo $this->ion_auth->gabung_tabel_userVerifikasiSeminar()->row()->komentar_seminar;
									}
									?>
								</th>
							</tr>
