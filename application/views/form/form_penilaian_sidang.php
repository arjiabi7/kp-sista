       ...
       <div class="form-group text-center mt-3 pb-3">
        ...
        <div class="row mt-3">
          <div class="form-group col-lg-12 text-center">
            ...
            <textarea style="height: 100px;" class="form-control text-center border-top-0 border-right-0 border-left-0" readonly><?=$this->ion_auth->gabung_tabel_userVerifikasiSidang()->row()->judul_skripsi;?></textarea>
          </div>
        </div>
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-2">
            <input type="text" class="form-control text-center" id="nilai1" maxlength="2" readonly>
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-10">
          ...
          <div class="form-group col-md-2">
            <input type="text" class="form-control text-center" id="nilai2" maxlength="2" readonly>
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-10">
          ...
          <div class="form-group col-md-2">
            <input type="text" class="form-control text-center" id="nilai3" maxlength="2" readonly>
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-10">
          ...
          <div class="form-group col-md-2">
            <input type="text" class="form-control text-center" id="nilai4" maxlength="2" readonly>
          </div>
        </div>
        <div class="form-group text-center mt-3 pb-3 pt-2">
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-2">
            <input type="text" class="form-control text-center" id="nilai5" maxlength="2" readonly>
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-10">
          ...
          <div class="form-group col-md-2">
            <input type="text" class="form-control text-center" id="nilai6" maxlength="2" readonly>
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-10">
          ...
          <div class="form-group col-md-2">
            <input type="text" class="form-control text-center" id="nilai7" maxlength="2" readonly>
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-10">
          ...
          <div class="form-group col-md-2">
            <input type="text" class="form-control text-center" id="nilai8" maxlength="2" readonly>
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-10">
          ...
          <div class="form-group col-md-2">
            <input type="text" class="form-control text-center" id="nilai9" maxlength="2" readonly>
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-10">
          ...
          <div class="form-group col-md-2">
            <input type="text" class="form-control text-center" id="nilai10" maxlength="2" readonly>
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-10">
          ...
          <div class="form-group col-md-2">
            <input type="text" class="form-control text-center" id="nilai11" maxlength="2" readonly>
          </div>
        </div>
